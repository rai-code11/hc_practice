...
class Suica:
    ...
    def show_balance(self):
        return f"ユーザー{self.user_id}の残高は{self.balance}円です"
...
class VM:
    ...
    def calculate_sales_amount(self):
        # 売上金額 = 売上金額 + 購入金額
        self.sales_amount += self.purchase_amount
    ...
    def add_stock(self, item_name):
        ...
        return self.drinks[item_name]


suica1 = Suica(1, 0)
print(suica1.charge(1000))
vm = VM()
vm.suica1.charge(1000)
